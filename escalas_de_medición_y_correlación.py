...
def regresion_lineal_model_3():
    ...
    # Retornar la tupla con (pendiente, ordenada al origen, coeficiente de correlación de Pearson)
    return (m, b, r)

# Llamar la función y mostrar resultado
resultado = regresion_lineal_model_3()
print(resultado)
...
# Llamar la función y mostrar resultado
resultado = regresion_lineal_model_s()
print(resultado)
...
# Llamar la función y mostrar resultado
resultado = regresion_lineal_model_x()
print(resultado)
...
# Llamar la función y mostrar resultado
resultado = regresion_lineal_model_y()
print(resultado)